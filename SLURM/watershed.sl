...
#SBATCH --output        slogs/watershed.%j.out
#SBATCH --error         slogs/watershed.%j.err
...
python3 /users/kir-fritzsche/aif490/devel/tissue_analysis/segmentation_scripts/watershed_seg.py \
    ...
    --verbose \
    --output      /users/kir-fritzsche/aif490/devel/tissue_analysis/lymphnode_analysis/data2track/b2-2a_2c_pos6-01_deskew_cgt/crop2/segmentation200/T0000_gamma1.00_diam30.0_masks_ws_test.tif \

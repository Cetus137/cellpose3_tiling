...
#SBATCH --output        slogs/ws.%j.out
#SBATCH --error         slogs/ws.%j.err
...
python3 /users/kir-fritzsche/aif490/devel/tissue_analysis/segmentation_scripts/watershed_seg.py \
    --input      /users/kir-fritzsche/aif490/devel/tissue_analysis/lymphnode_analysis/data2track/b2-2a_2c_pos6-01_deskew_cgt/crop2/segmentation200/video/combined_timelapse_diam3.tif \
    --verbose \
    --output_dir      /users/kir-fritzsche/aif490/devel/tissue_analysis/lymphnode_analysis/data2track/b2-2a_2c_pos6-01_deskew_cgt/crop2/segmentation200/ws \
    --t_list ${T0} \
